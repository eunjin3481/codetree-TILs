...
//        System.out.print("move santa: " + santa + ",");
...
//        System.out.println("산타 이동 후: " + finalSantaRow + " " + finalSantaCol);
    ...
    public static void pushSanta(int santa, int dir) {
//        System.out.println("push: " + santa + " ( " + santas[santa].r + ", " + santas[santa].c + ")");
        int nextRow = santas[santa].r + dr[dir];
        int nextCol = santas[santa].c + dc[dir];
...
//            System.out.println(map[nextRow][nextCol] + "(" + nextRow + ", " + nextCol + ")");
            pushSanta(map[nextRow][nextCol], dir);
        }
